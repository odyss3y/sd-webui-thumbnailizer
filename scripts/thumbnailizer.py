...
def get_preset_action_updates(set_name):
    ...
    return [gr.update(interactive=interactive) for _ in range(5)]
...
def on_ui_tabs():
    ...
    with gr.Blocks(analytics_enabled=False) as ui_component:
        ...
        with GradioBox(elem_classes="ch_box"):
            ...
            with gr.Accordion("Generation Preset Editor", open=False):
                ...
                with gr.Row():
                    ...
                    delete_preset_button = gr.Button("Delete Preset", interactive=not initial_preset_read_only)
        ...
        def on_set_change(set_name, folder_filter):
            ...
            return [gallery_data, target_update] + get_preset_editor_updates(set_name)
